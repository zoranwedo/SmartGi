<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DepartmentNew.aspx.vb" 
    Inherits="Accounting_DepartmentNew" enableEventValidation="false" %>
                ...
                <asp:FormView ID="fvDocDetail" runat="server" DataKeyNames="DocumentID" DataSourceID="dsAccTransDoc" DefaultMode="Edit">
                    <EditItemTemplate>
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="SelectRowClear" style="padding-left: 4px;"> Unit </td>
