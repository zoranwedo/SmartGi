<%@ Page Title="" Language="VB" MasterPageFile="~/Accounting/masterAccounting.master"
    ...
    Inherits="Accounting_AccDocDetail" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AccountContent" runat="Server">
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <asp:Panel runat="server" ID="pnlHCheck" Visible='<%# cbHotel.Checked %>' >
                                            ...
                                            <tr>
                                                <td class="SelectRow1B" style="padding-left: 4px;"> Hotel Amount </td>
                                                <td class="GridRow1B" >
                                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("HAmount", "{0:N2}") %>' Font-Bold="true" Width="100px" style="text-align: right;" />
                                                </td>
                                            </tr>
                                        </asp:Panel> 
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="SelectRow1B" style="padding-left: 4px;">Additional Info</td>
                                            <td class="GridRow1B" style="padding-left: 4px;">
                                                <%#AdditionalInvoice(Eval("InfoInvoice"))%>
                                                <%#AdditionalReservations(Eval("InfoReservation"))%>
                                                <%#AdditionalDates(Eval("InfoReceptionDate", "{0:d}"), Eval("InfoApprovalDate", "{0:d}"))%>
                                            </td>
                                        </tr>
    ...
    <uc:MessagePop ID="msgPop" runat="server" Title="Accounting Document Details" />
