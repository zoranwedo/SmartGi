<System.ComponentModel.DefaultBindingProperty("IntegerFrom")> _
Partial Class App_UserControls_FromToIntegerControl
    ...
    Public Property IntegerFrom() As String
        Get
            Return txtFrom.Text
        End Get
    ...
    <System.ComponentModel.Bindable(True)> _
    Public Property IntegerTo() As String
        Get
            Return txtTo.Text
        End Get
        Set(ByVal value As String)
    ...
    'Duration
    Public Function Duration(ByVal GreaterThan As Integer) As Boolean
        Dim r As Boolean = String.IsNullOrEmpty(txtFrom.Text) Or String.IsNullOrEmpty(txtTo.Text)
        If Not r Then r = Integer.Parse(txtTo.Text) - Integer.Parse(txtFrom.Text) > GreaterThan
        Return r
    End Function
