<%@ Page Title="" Language="VB" MasterPageFile="~/masterSMART.master" AutoEventWireup="false" 
    CodeFile="InvoiceJournalDetailComp.aspx.vb" Inherits="Reports_Invoices_InvoiceJournalDetailComp" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    Invoice Journal Detail Compare 
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MasterContent" Runat="Server">
                    ...
                    <asp:Panel ID="pnSearch" runat="server" DefaultButton="btReport" style="padding-left: 8px;">
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="ComandRow2T" colspan="3" style="height: 28px; padding-top: 5px; text-align: right;" >
    ...
    <asp:ObjectDataSource ID="dsFilteredInvoicesCompConcept" runat="server" 
        ...
        TypeName="dsConceptTableAdapters.Invoice_DetailCompareTableAdapter">
        <SelectParameters>
            <asp:ControlParameter ControlID="cbHotel" Name="HRate" PropertyName="Checked" Type="Boolean" />
            <asp:Parameter Name="InvDoc" Type="String" />
            ...
            <asp:Parameter Name="IncludeCancel" Type="Boolean" DefaultValue="False" />
        </SelectParameters>
    </asp:ObjectDataSource>
</asp:Content>
