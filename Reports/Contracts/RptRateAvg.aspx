<%@ Page Title="" Language="VB" MasterPageFile="~/masterSMART.master" AutoEventWireup="false" CodeFile="RptRateAvg.aspx.vb" Inherits="Reports_Contracts_RptRateAvg" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <p>
        Contracted Average Rate</p>
</asp:Content>
                                ...
                                <tr>
                                    ...
                                    <td class="GridRow1B" style="width: 400px" align="left">
                                        ...
                                        <asp:DropDownList ID="ddlContract" runat="server" CssClass="TextBox" 
                                            DataSourceID="dsContract" DataTextField="Title" DataValueField="Title" 
                                ...
                                <tr>
                                    ...
                                    <td class="GridRow1B">
                                        ...
                                        <asp:ObjectDataSource ID="dsRateType" runat="server" DeleteMethod="Delete" 
                                            InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" 
                                            SelectMethod="GetData" 
                                            TypeName="dsMaintBasicTableAdapters.RateTypeTableAdapter" UpdateMethod="Update">
                                            <DeleteParameters>
                    ...
                    <tr>
                        <td style="text-align: right; padding-top: 5px; height: 30px;">
                            <asp:ObjectDataSource ID="dsCntRates" runat="server" 
                                ...
                                TypeName="CntReportsTableAdapters.FilterContractAvgTableAdapter">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="hfUsername" Name="UserName" 
                                        PropertyName="value" Type="String" />
