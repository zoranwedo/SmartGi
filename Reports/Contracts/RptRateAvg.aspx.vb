...
Partial Class Reports_Contracts_RptRateAvg
    ...
    Protected Sub lbCntRates_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbCntRates.Click
        ...
        lr.ReportPath = "Reports\Contracts\RptContractAverage.rdlc"
        ...
        lr.DataSources.Add(New Microsoft.Reporting.WebForms.ReportDataSource("CntReports_FilterContractAvg", dsCntRates))
    ...
    Protected Sub FilterString()
        ...
        If Not cblReceived.Items(0).Selected Then
            ...
            dsCntRates.FilterExpression = strFilter
        End If
