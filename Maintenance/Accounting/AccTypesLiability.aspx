<%@ Page Title="" Language="VB" MasterPageFile="~/Maintenance/Accounting/masterTypes.master" AutoEventWireup="false" CodeFile="AccTypesLiability.aspx.vb" Inherits="Maintenance_Accounting_AccTypesLiability" %>
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td class="GridLabelBG">
                    <asp:Label ID="lblDep" runat="server" Text="Liability Concepts" SkinID="skGridLabel" />
            ...
            <tr>
                <td class="GridBorder">
                    <asp:GridView ID="gvLiability" runat="server" SkinID="skGridView" AllowSorting="True"
                        AutoGenerateColumns="False" DataKeyNames="AccLiabilityConceptID" 
                        DataSourceID="dsLiabilities" >
                        <Columns>
                            <asp:BoundField DataField="AccLiabilityConceptID" HeaderText="AccLiabilityConceptID" 
                                InsertVisible="False" ReadOnly="True" SortExpression="AccLiabilityConceptID" 
                                Visible="False" />
                            <asp:BoundField DataField="AccLiabilityConceptName" 
                                HeaderText="Name" SortExpression="AccLiabilityConceptName" >
                                <ControlStyle CssClass="TextBox" />
                                <ItemStyle Width="250px" />
                            </asp:BoundField>
                            <asp:CheckBoxField DataField="AccLiabilityConceptIsActive" 
                                HeaderText="Active" SortExpression="AccLiabilityConceptIsActive" >
                    ...
                    <asp:FormView ID="newType" runat="server" DataSourceID="dsLiabilities" HorizontalAlign="Right" >
                        <InsertItemTemplate>
                               ...
                               <tr>
                                ...
                                <tr class="GridRow1T">
                                    <td style="height: 30px; padding-right: 2px;">
                                        <asp:TextBox ID="NameTextBox" runat="server" Text='<%# Bind("AccLiabilityConceptName") %>' 
                                            CssClass="TextBox" />
                                    ...
                                    <td style="width: 50px;">
                                        <asp:CheckBox ID="cbActive" runat="server" Checked='<%# Bind("AccLiabilityConceptIsActive") %>' />
                                    </td>
                    ...
                    <asp:ObjectDataSource ID="dsLiabilities" runat="server" DeleteMethod="Delete" 
                        InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="GetActive" 
                        TypeName="AccUnitsTableAdapters.AccLiabilityConceptTableAdapter" 
                        UpdateMethod="Update">
                        <DeleteParameters>
                            <asp:Parameter Name="Original_AccLiabilityConceptID" Type="Int32" />
                        </DeleteParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="AccLiabilityConceptName" Type="String" />
                            <asp:Parameter Name="AccLiabilityConceptIsActive" Type="Boolean" />
                            <asp:Parameter Name="Original_AccLiabilityConceptID" Type="Int32" />
                        </UpdateParameters>
                        <SelectParameters>
