<%@ Page Title="" Language="VB" MasterPageFile="~/Maintenance/Accounting/masterTypes.master" AutoEventWireup="false" 
    CodeFile="AccTypesIncome.aspx.vb" Inherits="Maintenance_Accounting_AccTypesIncome" %>
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td class="GridLabelBG">
                    <asp:Label ID="lblDep" runat="server" Text="Income Types" SkinID="skGridLabel" />
            ...
            <tr>
                <td class="GridBorder">
                    <asp:GridView ID="gvIncome" runat="server" SkinID="skGridView" AllowSorting="True"
                        AutoGenerateColumns="False" DataKeyNames="AccIncomeTypeID" 
                        DataSourceID="dsTypes" >
                        <Columns>
                            <asp:BoundField DataField="AccIncomeTypeID" HeaderText="AccIncomeTypeID" 
                                InsertVisible="False" ReadOnly="True" SortExpression="AccIncomeTypeID" 
                                Visible="False" />
                            <asp:BoundField DataField="AccIncomeTypeName" 
                                HeaderText="Name" SortExpression="AccIncomeTypeName" >
                                <ControlStyle CssClass="TextBox" />
                                <ItemStyle Width="250px" />
                            </asp:BoundField>
                            <asp:CheckBoxField DataField="AccIncomeTypeIsActive" 
                                HeaderText="Active" SortExpression="AccIncomeTypeIsActive" >
                               ...
                               <tr>
                                ...
                                <tr class="GridRow1T">
                                    <td style="height: 30px; padding-right: 2px;">
                                        <asp:TextBox ID="NameTextBox" runat="server" Text='<%# Bind("AccIncomeTypeName") %>' 
                                            CssClass="TextBox" />
                                    ...
                                    <td style="width: 50px;">
                                        <asp:CheckBox ID="cbActive" runat="server" Checked='<%# Bind("AccIncomeTypeIsActive") %>' />
                                    </td>
                    ...
                    <asp:ObjectDataSource ID="dsTypes" runat="server" DeleteMethod="Delete" 
                        ...
                        TypeName="AccUnitsTableAdapters.AccIncomeTypeTableAdapter" 
                        UpdateMethod="Update">
                        <DeleteParameters>
                            <asp:Parameter Name="Original_AccIncomeTypeID" Type="Int32" />
                        </DeleteParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="AccIncomeTypeName" Type="String" />
                            <asp:Parameter Name="AccIncomeTypeIsActive" Type="Boolean" />
                            <asp:Parameter Name="Original_AccIncomeTypeID" Type="Int32" />
                        </UpdateParameters>
                        <SelectParameters>
