<%@ Page Title="" Language="VB" MasterPageFile="~/Maintenance/RateTransfer/masterRtTransf.master"
    AutoEventWireup="false" CodeFile="RTransfLog.aspx.vb" Inherits="Maintenance_RateTransfer_RTransfLog" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="GridBorder" style="width: 600px; height: 20px;">
                    ...
                    <tr>
                        <td class="GridBorder" style="width: 600px; height: 20px; margin-top: 2px;">
