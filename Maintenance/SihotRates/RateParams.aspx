<%@ Page Language="VB" MasterPageFile="~/Maintenance/SihotRates/RateSihot.master" AutoEventWireup="false" CodeFile="RateParams.aspx.vb" 
    Inherits="Maintenance_SihotRates_RateParams" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">
    SIHOT Rate Import Parameters 
</asp:Content>
        ...
        <ContentTemplate>
            <div class="Blue">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="GridBorder">
                            <asp:GridView ID="gvRateParams" runat="server" SkinID="skGridView" AutoGenerateColumns="False"
                                DataKeyNames="hotelCode" DataSourceID="dsRateParams">
                                <Columns>
                                    <%--
                            ...
                            <%--
                            <asp:FormView ID="fvRateParams" runat="server" SkinID="formviewTitle" DataKeyNames="hotelCode"
                                DataSourceID="dsRateParams">
                                <ItemTemplate>
                            ...
                            --%>
                            <asp:ObjectDataSource ID="dsRateParams" runat="server" 
                                TypeName="dsSIHOTTableAdapters.RateParamsTableAdapter"
                                SelectMethod="GetData" 
                                UpdateMethod="UpdateQuery" DeleteMethod="DeleteQuery" 
                                InsertMethod="InsertQuery">
                                <DeleteParameters>
                                    <asp:Parameter Name="editUser" Type="String" />
                                    <asp:Parameter Name="hotelCode" Type="Int32" DefaultValue="0" />
                                </DeleteParameters>
                                <UpdateParameters>
                                    ...
                                    <asp:ControlParameter ControlID="dummy" Name="editUser" PropertyName="Value" Type="String" />
                                    <asp:Parameter Name="hotelCode" Type="Int32" DefaultValue="0" />
                                </UpdateParameters>
                                <InsertParameters>
                                    <asp:Parameter Name="hotelCode" Type="Int32" DefaultValue="0" />
