<%@ Page Title="" Language="VB" MasterPageFile="~/Contracts/Special/masterSpecial.master"
    AutoEventWireup="false" CodeFile="SpecRate.aspx.vb" Inherits="Contracts_Special_SpecRate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="WizardContent" runat="Server">
    <div class="Blue">
        <table>
            ...
            <tr>
                <td colspan="2">
                    <asp:DropDownList ID="ddlContract" runat="server" CssClass="TextBox" 
                        AutoPostBack="True" DataSourceID="dsContract" DataTextField="CtrLabel" 
                        DataValueField="ContractId" Width="100%">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class=" GridBorder" valign="top">
                    ...
                    <asp:ObjectDataSource ID="dsContractRate" runat="server" DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}"
                        SelectMethod="GetSpecialRate4Contract" TypeName="dsSpecialTableAdapters.ContractRateTableAdapter"
                        InsertMethod="Insert">
                        <DeleteParameters>
                        ...
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="ddlContract" Name="ContractID" 
                ...
                <td valign="top" class=" GridBorder">
                    <asp:DetailsView ID="dvContractRate" runat="server" Width="400px" AutoGenerateRows="False"
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Per" SortExpression="PerPax">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="RateExtra" SortExpression="RateExtra">
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddlRateExtra" runat="server" Enabled="False" 
                                        SelectedValue='<%# Bind("RateExtra") %>'>
                        ...
                        <EmptyDataTemplate>
                            <b>Special is not attached to any contract.<br />
                                Go back to Application page.</b>
                        </EmptyDataTemplate>
                    </asp:DetailsView>
                </td>
            </tr>
        ...
        <asp:CheckBox ID="cbActivate" runat="server" Checked="True" 
            Text="Activate Special On Finish" Visible="False" />
...
<asp:ObjectDataSource ID="dsContract" runat="server" 
    OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" 
    TypeName="dsSpecialTableAdapters.SelectContractTableAdapter">
    <SelectParameters>
