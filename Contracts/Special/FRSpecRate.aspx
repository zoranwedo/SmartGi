<%@ Page Title="" Language="VB" MasterPageFile="~/Contracts/Special/masterFRSpecial.master" AutoEventWireup="false" CodeFile="FRSpecRate.aspx.vb" Inherits="Contracts_Special_FRSpecRate" %>
...
<asp:GridView ID="gvRates" runat="server" AutoGenerateColumns="False" 
        ...
        DataKeyNames="ContractRateID,HotelId,RateCodeId,RoomTypeId,MealPlanId,CtrPeriodId,Start,Finish,ContractId" DataSourceID="dsContractRate" 
        SkinID="skGridView" Width="347px" SelectedIndex="0">
    <Columns>
        ...
        <asp:BoundField DataField="ContractRateID" HeaderText="ContractRateID" 
            InsertVisible="False" ReadOnly="True" SortExpression="ContractRateID" 
            Visible="False" />
        ...
        <asp:BoundField DataField="CtrPeriodId" HeaderText="CtrPeriodId" 
            SortExpression="CtrPeriodId" Visible="False" />
    ...
    <asp:ObjectDataSource ID="dsContractRate" runat="server" DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" 
        SelectMethod="GetDataBySpecID" 
        TypeName="dsSpecialTableAdapters.ContractRateTableAdapter" 
                    ...
                    <asp:DetailsView ID="dvContractRate" runat="server" Width="400px" AutoGenerateRows="False"
                        ...
                        <Fields>
                            <asp:TemplateField ShowHeader="False">
                                <EditItemTemplate>
                        <asp:Label ID="Label18" runat="server" Text="Selected Rate" SkinID="skGridLabel" />
                                <div style="float: right; margin-top: 8px;">
                                    <asp:ImageButton ID="btnPrev" runat="server" CausesValidation="False" CommandName="Prev"
                                                    ToolTip="Go to previous rate" ImageUrl="~/Images/left_all.png" BackColor="White" />&nbsp;
                                    <asp:ImageButton ID="btnNext" runat="server" CausesValidation="False" CommandName="Next"
                                                    ToolTip="Go to next rate" ImageUrl="~/Images/right_all.png" BackColor="White" />&nbsp;
                                </div>
                                </EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="PerPax" SortExpression="PerPax">
                                <ItemTemplate>
                                    <asp:CheckBox ID="CheckBox2" runat="server" Checked='<%# Bind("PerPax") %>' 
                                        Enabled="false" />
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="LockChildrenRates" SortExpression="LockChildrenRates">
                                <ItemTemplate>
                                ...
                                <EditItemTemplate>
                                    <asp:CheckBox ID="cbLock" runat="server" Checked='<%# Eval("LockChildrenRates") %>'
                                        AutoPostBack="True" OnCheckedChanged="cbLock_CheckedChanged" 
                                        OnDataBinding="cbLock_DataBinding" Enabled="False" />
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Bind("LockChildrenRates") %>' />
                                </InsertItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="RateExtra" SortExpression="RateExtra">
                                ...
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddlRateExtra" runat="server" SelectedValue='<%# Bind("RateExtra") %>'
                                        ...
                                        <asp:ListItem Value="1">Pax1</asp:ListItem>
                                        <asp:ListItem Value="2">Pax2</asp:ListItem>
                                        <asp:ListItem Value="3">Pax3</asp:ListItem>
                                        <asp:ListItem Value="4">Pax4</asp:ListItem>
                                        <asp:ListItem Value="5">Pax5</asp:ListItem>
                                        <asp:ListItem Value="6">Pax6</asp:ListItem>
                                        <asp:ListItem Value="7">Pax7</asp:ListItem>
                                        <asp:ListItem Value="8">Pax8</asp:ListItem>
                                        <asp:ListItem Value="9">Pax9</asp:ListItem>
                                    </asp:DropDownList>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Allotment" SortExpression="Allotment">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtAllotment" runat="server" Text='<%# Bind("Allotment") %>' Width="80%" CssClass="TextBox"></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="CutOff" SortExpression="CutOff">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtCutOff" runat="server" Text='<%# Bind("CutOff") %>' Width="80%" CssClass="TextBox"></asp:TextBox>
...
<asp:HiddenField ID="dummy" runat="server" />
        <asp:CheckBox ID="cbActivate" runat="server" Checked="True" 
            Text="Activate Special On Finish" />
    <asp:ObjectDataSource ID="dsRateDetail" runat="server" DeleteMethod="Delete" 
        InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" 
        SelectMethod="GetDataByCntRateID" 
        TypeName="dsSpecialTableAdapters.ContractRateTableAdapter" 
        UpdateMethod="Update">
        <DeleteParameters>
            <asp:Parameter Name="Original_ContractRateID" Type="Int64" />
        ...
        <UpdateParameters>
            <asp:ControlParameter ControlID="gvRates" Name="ContractId" 
                PropertyName="SelectedDataKey(8)" Type="Int32" />
            <asp:ControlParameter ControlID="gvRates" Name="HotelId" 
                PropertyName="SelectedDataKey(1)" Type="Int32" />
            <asp:ControlParameter ControlID="gvRates" Name="RateCodeId" 
                PropertyName="SelectedDataKey(2)" Type="String" />
            <asp:ControlParameter ControlID="gvRates" Name="MealPlanId" 
                PropertyName="SelectedDataKey(4)" Type="String" />
            <asp:ControlParameter ControlID="gvRates" Name="RoomTypeId" 
                PropertyName="SelectedDataKey(3)" Type="String" />
            <asp:ControlParameter ControlID="gvRates" Name="Start" 
                PropertyName="SelectedDataKey(6)" Type="DateTime" />
            <asp:ControlParameter ControlID="gvRates" Name="Finish" 
                PropertyName="SelectedDataKey(7)" Type="DateTime" />
            <asp:Parameter Name="PerPax" Type="Boolean" />
            <asp:Parameter Name="RateOption" Type="Int16" />
            <asp:Parameter Name="RatePax1" Type="Decimal" />
            <asp:Parameter Name="RatePax2" Type="Decimal" />
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="gvRates" Name="ContractRateID" 
