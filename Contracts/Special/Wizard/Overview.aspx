<%@ Page Title="" Language="VB" MasterPageFile="~/Contracts/Special/Wizard/masterWizard.master"
    AutoEventWireup="false" CodeFile="Overview.aspx.vb" Inherits="Contracts_Special_Wizard_Overview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="WizardContent" runat="Server">
    <div class="Red">
                            <asp:Button ID="linkNew" runat="server" 
            Text="Print Rate Sheet" SkinID="skBtnBase" />
            ...
            <SelectParameters>
                <asp:QueryStringParameter Name="ContractId" QueryStringField="ContractID" Type="Int32" />
                            ...
                            <asp:ObjectDataSource ID="dsCntRates" runat="server" 
                                OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByOverview" 
            ...
            <ItemTemplate>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Chld1ShLabelLabel" runat="server" 
                                Text='<%# "(" & Eval("Chld1ShLabel") & "):" %>' 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Chld2ShLabelLabel" runat="server" 
                                Text='<%# "(" & Eval("Chld2ShLabel") & "):" %>' 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Chld3ShLabelLabel" runat="server" 
                                Text='<%# "(" & Eval("Chld3ShLabel") & "):" %>' 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Chld4ShLabelLabel" runat="server" 
                                Text='<%# "(" & Eval("Chld4ShLabel") & "):" %>' 
