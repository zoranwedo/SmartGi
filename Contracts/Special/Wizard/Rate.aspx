<%@ Page Title="" Language="VB" MasterPageFile="~/Contracts/Special/Wizard/masterWizard.master"
    AutoEventWireup="false" CodeFile="Rate.aspx.vb" Inherits="Contracts_Special_Wizard_Rate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="WizardContent" runat="Server">
    <div class="Red" style="height: 100%">
                    ...
                    <asp:DetailsView ID="dvContractRate" runat="server" Width="400px" AutoGenerateRows="False"
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Single" SortExpression="RatePax1">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("RatePax1", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Double" SortExpression="RatePax2">
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("RatePax2", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Triple" SortExpression="RatePax3">
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("RatePax3", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Quadruple" SortExpression="RatePax4">
                                <ItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("RatePax4", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Quintuple" SortExpression="RatePax5">
                                <ItemTemplate>
                                    <asp:Label ID="Label6" runat="server" Text='<%# Eval("RatePax5", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Sextuple" SortExpression="RatePax6">
                                <ItemTemplate>
                                    <asp:Label ID="Label7" runat="server" Text='<%# Eval("RatePax6", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Septuple" SortExpression="RatePax7">
                                <ItemTemplate>
                                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("RatePax7", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Octuple" SortExpression="RatePax8">
                                <ItemTemplate>
                                    <asp:Label ID="Label9" runat="server" Text='<%# Eval("RatePax8", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Nonuple" SortExpression="RatePax9">
                                <ItemTemplate>
                                    <asp:Label ID="Label10" runat="server" Text='<%# Eval("RatePax9", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Decuple" SortExpression="RatePax10">
                                <ItemTemplate>
                                    <asp:Label ID="Label11" runat="server" Text='<%# Eval("RatePax10", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Use as Extra Rate" SortExpression="RateExtra" >
                                <ItemTemplate>
                                    <asp:Label ID="Label16" runat="server" Text='<%# Eval("RateExtra") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="RateChld1" SortExpression="RateChld1">
                                <ItemTemplate>
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("RateChld1", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox11" runat="server" Text='<%# Bind("RateChld1", "{0:F2}") %>'></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="RateChld2" SortExpression="RateChld2">
                                <ItemTemplate>
                                    <asp:Label ID="Label13" runat="server" Text='<%# Bind("RateChld2", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="RateChld3" SortExpression="RateChld3">
                                <ItemTemplate>
                                    <asp:Label ID="Label14" runat="server" Text='<%# Eval("RateChld3", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="RateChld4" SortExpression="RateChld4">
                                <ItemTemplate>
                                    <asp:Label ID="Label15" runat="server" Text='<%# Eval("RateChld4", "{0:F2}") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Desctiption" SortExpression="Desctiption">
                                <ItemTemplate>
                                    <asp:Label ID="Label17" runat="server" Text='<%# Eval("Desctiption") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                ...
                                <ItemTemplate>
                                    <div style="text-align: right; margin-top: 5px; height: 30px">
                                        <asp:Button ID="Button1" runat="server" 
                                            CommandName="Edit" SkinID="skBtnBase" Text="Edit Rates" 
                                            onclick="Button1_Click" Visible="<%# Master.CanEdit() %>" />
                                        &nbsp;</div>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    ...
                                    <div style="text-align: right; margin-top: 5px; height: 30px">
                                        <asp:Button ID="Button1" runat="server" CommandName="Update"
                                            SkinID="skBtnBase" Text="Update" Visible="<%# Master.CanEdit() %>" />
                                        &nbsp;<asp:Button ID="Button2" runat="server" CausesValidation="False" CommandName="Cancel"
                                            SkinID="skBtnBase" Text="Cancel" Visible="<%# Master.CanEdit() %>" />
                                    </div>
                                </EditItemTemplate>
                            </asp:TemplateField>
                        </Fields>
        ...
        <asp:ObjectDataSource ID="dsContractRate" runat="server" DeleteMethod="Delete" InsertMethod="Insert"
            ...
            SelectMethod="GetDataSpecialByCID" TypeName="ContractsTableAdapters.ContractRateTableAdapter"
            UpdateMethod="Update">
            <DeleteParameters>
        ...
        <asp:ObjectDataSource ID="dsRateDetail" runat="server" DeleteMethod="Delete" InsertMethod="Insert"
            ...
            <UpdateParameters>
                ...
                <asp:ControlParameter ControlID="gvRates" Name="RoomTypeId" PropertyName="SelectedDataKey(3)"
                    Type="String" />
                <asp:ControlParameter ControlID="gvRates" Name="CtrPeriodId" PropertyName="SelectedDataKey(5)"
                    Type="Int32" />
