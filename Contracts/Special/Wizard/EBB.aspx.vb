...
Partial Class Contracts_Wizard_EBB
    Inherits System.Web.UI.Page

    Protected Sub dsSpec_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles dsSpec.Inserted
        Dim q As New dsSpecialTableAdapters.QueriesTableAdapter
        Dim str As String = e.OutputParameters.Item("NewID")
        Dim netcd As String = "NET"
        ...
        Else
            Try
                q.SpecialContractAttach(str, Request.QueryString(0), Membership.GetUser.UserName)
        ...
        '    ' Response.Redirect(String.Format("EBB.aspx?SpecialID={0}", str))
        'End If
    End Sub
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        fvSpec.ChangeMode(FormViewMode.Insert)
    End Sub
