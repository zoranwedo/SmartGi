...
Partial Class Contracts_Special_Wizard_Periods
    ...
    Protected Sub newMarket_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewPageEventArgs) Handles newMarket.PageIndexChanging
