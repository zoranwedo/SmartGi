<%@ Page Title="" Language="VB" MasterPageFile="~/Contracts/Special/masterSpecial.master"
    AutoEventWireup="false" CodeFile="SpecPeriod.aspx.vb" Inherits="Contracts_Special_SpecPeriod" %>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="GridBorder" valign="top">
                    ...
                    <asp:FormView ID="newMarket" runat="server" DataSourceID="dsPeriods" DataKeyNames="SpcPeriodID">
                        <InsertItemTemplate>
                    ...
                    <asp:ObjectDataSource ID="dsPeriods" runat="server" SelectMethod="GetData" TypeName="dsSpecialTableAdapters.SpecialPeriodTableAdapter"
