<%@ Page Title="" Language="VB" MasterPageFile="~/Contracts/Wizard/masterWizard.master"
    AutoEventWireup="false" CodeFile="Periods.aspx.vb" Inherits="Contracts_Wizard_Periods" %>
                ...
                <td class="GridBorder" valign="top">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton ID="ibSplit" runat="server" CausesValidation="False" 
                                        CommandName="Split" CommandArgument='<%# Bind("CtrPeriodID") %>'
                                        ToolTip="Split period" OnClientClick="confirm('Are you sure you want to split the period?')"
                                        ImageUrl="~/Images/unpublish_inline.gif" Text="Split" 
                                        Visible="<%# Master.CanEdit() %>" oncommand="ibSplit_Command" />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" CommandName="Delete"
                                        ImageUrl="~/Images/delete_inline.gif" OnClientClick="confirm('Are you sure you want to delete the period?')"
                                        ToolTip="Delete period" Text="Delete" Visible="<%# Master.CanEdit() %>" />
                                </ItemTemplate>
                                <ControlStyle CssClass="ImgButton" />
                    ...
                    <asp:FormView ID="newMarket" runat="server" DataSourceID="dsPeriods" DataKeyNames="ContractId">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="border-style: None; border-collapse: collapse;">
                                <tr class="GridRow1T">
                                    ...
                                    <td style="width: 600px;">
                                        <asp:TextBox ID="NoteTextBox" runat="server" Text='<%# Bind("Note") %>'  Height="600px"
                                            CssClass="TextBox" TextMode="MultiLine" />
                                    </td>
                                    <td style="width: 75px;">
                        ...
                        <ItemTemplate>
                            <table cellpadding="0" cellspacing="0" border="0" style="border-style: None; border-collapse: collapse;">
                                <tr class="GridRow1T">
                                    <td style="width: 805px; height: 30px;">
                                        &nbsp;
                                    </td>
