<%@ Page Title="" Language="VB" MasterPageFile="~/Contracts/Wizard/masterWizard.master"
    AutoEventWireup="false" CodeFile="Penality.aspx.vb" Inherits="Contracts_Wizard_Penality" %>
                    ...
                    <td class="GridBorder" style="vertical-align: top;" valign="top">
                        <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>--%>
                                ...
                                <asp:FormView ID="fvOccupancy" runat="server" DataKeyNames="CtrNoShowID" DataSourceID="dsNoShow">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="border-style: None; border-collapse: collapse;">
                                            <tr class="GridRow1T">
                                                ...
                                                <td style="width: 79px; padding-top:5px; padding-bottom:5px; text-align:right;">
                                                    <asp:Button ID="btnNsNew" runat="server" CommandName="New" SkinID="skBtnBase" 
                        ...
                        <%--<asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>--%>
                                <asp:GridView ID="gvCancel" runat="server" AutoGenerateColumns="False" DataKeyNames="CtrCancelID"
                                    DataSourceID="dsCancelation" SkinID="skGridView">
                                    <Columns>
                                ...
                                <asp:FormView ID="fvCancelation" runat="server" DataSourceID="dsCancelation" >
                                    <RowStyle HorizontalAlign="Right" />
                                    <InsertItemTemplate>
                                    ...
                                    <ItemTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" 
                                            ...
                                            <tr class="GridRow1T">
                                                <td style="width: 488px;">&nbsp;</td>
                                                <td style="width: 79px; padding-top:5px; padding-bottom:5px; text-align:right;">
                                                    <asp:Button ID="btCancNew" runat="server" CommandName="New" SkinID="skBtnBase" 
                                                        Text="New" Visible="<%# Master.CanEdit() %>" />
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <asp:ObjectDataSource ID="dsCancelation" runat="server"
                                    OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByContractID"
