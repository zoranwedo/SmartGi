...
Partial Class Contracts_Wizard_Rooms
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        gridRoom.Enabled = Master.CanEdit
    ...
    'Protected Sub gvRooms_RowUpdated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdatedEventArgs) Handles gvRooms.RowUpdated
    '    If e.Exception IsNot Nothing Then MsgBox(e.Exception.Message)
    'End Sub
End Class
