...
Partial Class Contracts_Create_CreateFromTemplate
    ...
    Protected Sub btnSelect_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        ...
        gvContracts.Visible = True
        cpeContract.Collapsed = True
        cpeTourOps.Collapsed = False
    End Sub

    Protected Sub btnClearTO_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnClearTO.Click
        gvTO.Visible = False
