<%@ Page Title="" Language="VB" MasterPageFile="~/Contracts/Create/masterNewCnt.master" MaintainScrollPositionOnPostback="true" 
    AutoEventWireup="false" CodeFile="CreateFromTemplate.aspx.vb" Inherits="Contracts_Create_CreateFromTemplate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CreateCntContent" runat="Server">
    <div class="Green">
        <asp:CollapsiblePanelExtender ID="cpeContract" runat="server" TargetControlID="pnlContract"
            CollapseControlID="lblContract" ExpandControlID="lblContract" ImageControlID="imgExpContract"
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td class="GridLabelBG" width="600px">
                    <asp:Label ID="lblContract" runat="server" SkinID="skGridLabel">Search/Filter for Template&nbsp;
                        <asp:Image ID="imgExpContract" runat="server" ImageUrl="~/Images/collapse_.png" />&nbsp; 
                    </asp:Label>
                </td>
            </tr>
            <tr>
                <td class="GridBorder" style="width: 600px">
                    <asp:Panel ID="pnlContract" runat="server">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="GridRow2B" style="width: 100px; text-align: left;">Template ID</td>
                                ...
                                <td class="GridRow2B" style="width: 100px; text-align: right;">
                                    <asp:Button ID="btnSelect" runat="server" SkinID="skBtnBase" Text="Select" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="GridRow1B" colspan="2">
                                    ...
                                    <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="fltName"
                                        WatermarkCssClass="WaterMark" WatermarkText="Contract template title (use % as wildchar)" />
                                </td>
                            </tr>
                            <tr>
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td class="GridLabelBG">
                    <asp:Label ID="lbHotels" runat="server" Text="Template" SkinID="skGridLabel"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="GridBorder" style="min-width: 616px;">
                    <asp:GridView ID="gvContracts" runat="server" DataSourceID="dsFilteredContracts"
                        ...
                        <EmptyDataTemplate>
                            <div style="width: 600px;">
                                No contract template found for specified filter.
                            </div>
                        </EmptyDataTemplate>
                    </asp:GridView>
                    <asp:ObjectDataSource ID="dsFilteredContracts" runat="server" OldValuesParameterFormatString="original_{0}"
                        SelectMethod="FilterTemplates" TypeName="ContractsTableAdapters.ContractTableAdapter">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="hfUsername" Name="UserName" PropertyName="Value" Type="String" />
                    ...
                    <asp:ObjectDataSource ID="dsSelectContract" runat="server" OldValuesParameterFormatString="original_{0}"
                        ...
                        <SelectParameters>
                            ...
                            <asp:Parameter Name="Start" Type="String" DefaultValue="" />
                            <asp:Parameter Name="Finish" Type="DateTime" DefaultValue="" />
                            <asp:Parameter Name="Title" Type="DateTime" DefaultValue="" />
    ...
    <br />
    <div class="Green">
        <asp:CollapsiblePanelExtender ID="cpeTourOps" runat="server" TargetControlID="pnlTourOps"
            CollapseControlID="lblTourOps" ExpandControlID="lblTourOps" ImageControlID="imgExpTourOps"
            CollapsedImage="~/Images/expand_.png" ExpandedImage="~/Images/collapse_.png"
            Collapsed="False">
        </asp:CollapsiblePanelExtender>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td class="GridLabelBG" width="600px">
                    <asp:Label ID="lblTourOps" runat="server" SkinID="skGridLabel">
                        Search/Filter for TO&nbsp;
                        <asp:Image ID="imgExpTourOps" runat="server" ImageUrl="~/Images/collapse_.png" />&nbsp; 
                    </asp:Label>
                </td>
            </tr>
            <tr>
                <td class="GridBorder" style="width: 600px">
                    <asp:Panel ID="pnlTourOps" runat="server">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" class="ComandRow2T">
                                    ...
                                    <asp:Button ID="btnSearchTO" runat="server" SkinID="skBtnFilter" />&nbsp;
                                    <asp:Button ID="btnClearTO" runat="server" SkinID="skBtnClear" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
