<%@ Page Title="" Language="VB" MasterPageFile="~/Contracts/Create/masterNewCnt.master" AutoEventWireup="false" CodeFile="Create.aspx.vb" Inherits="Contracts_Create_Create" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CreateCntContent" Runat="Server">
    <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" Height="650px" 
        ...
        <WizardSteps>
            <asp:WizardStep ID="WizardStep1" runat="server" title="Hotels" StepType="Start">
                <div class="Green">
                        ...
                        <tr>
                            <td class="GridBorder">
                                <asp:GridView ID="gvHotels" runat="server" AutoGenerateColumns="False" 
                                    DataKeyNames="HotelID,Hotel" DataSourceID="dsHotels" SkinID="skGridView" 
            ...
            <asp:WizardStep ID="WizardStep2" runat="server" title="Tour Operator">
              <div class="Green">
            <table cellpadding="0" cellspacing="0">
            <tr>
                           ...
                           <tr>
                                ...
                                <td class="GridRow1B">
                                    <asp:DropDownList ID="ddlTO" runat="server" AutoPostBack="True" 
                                        CssClass="TextBox" DataSourceID="dsTOAll" DataTextField="TourOp" 
                                        DataValueField="TourOpID" Width="300px">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td class="GridRow1B">
                                    <asp:TextBox ID="fltNameTO" runat="server" CssClass="TextBox" Width="300px"></asp:TextBox>
                                    <asp:TextBoxWatermarkExtender ID="fltNameExt" runat="server" Enabled="True" 
                                        TargetControlID="fltNameTO" WatermarkCssClass="WaterMark" 
    ...
    <br />
            ...
            <asp:WizardStep ID="WizardStep3" runat="server" StepType="Finish" Title="Details">
            <div class="Blue">
                ...
                <asp:FormView ID="FormView1" runat="server" DataKeyNames="ContractID" 
                    ...
                    <InsertItemTemplate>
                        ...
                        <asp:TextBox ID="StartTextBox" runat="server" 
                            ...
                            ontextchanged="StartTextBox_TextChanged" />
        ...
        <HeaderTemplate>
                    <table cellpadding="0" cellspacing="0" width="100%" >
                        <tr style="font-size: x-small;">
                            ...
                            <td ><%="(" & gvHotels.SelectedDataKey(0) & ") " & gvHotels.SelectedDataKey(1)%></td>
                        </tr>
                        <tr style="font-size: x-small;">
