<%@ Page Language="VB" MasterPageFile="~/masterSMART.master" AutoEventWireup="false"
    CodeFile="ProForm.aspx.vb" Inherits="Proforma_ProForm" enableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanelPage" runat="server">
                                ...
                                <ItemTemplate>
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: top;" rowspan="8" colspan="4">
                                                    ...
                                                    <tr>--%>
                                                        <asp:Panel ID="Panel3" runat="server" Visible='<%# Eval("rnH")>0 %>'>
                                                            ...
                                                            <td class="PreRow" style="text-align: left;">
                                                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("RateCodeID") %>' />
                                                            </td>
                                                            <td class="PreRow">
                                                                <asp:Label ID="Label26" runat="server" Text='<%# Eval("BkDate","{0:d}") %>' />
                                                            </td>
                                                            <td class="PreRow">
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("Arrival","{0:d}") %>' />
                                                            </td>
                                                            <td class="PreRow">
                                                                <asp:Label ID="Label5" runat="server" Text='<%# Eval("Departure","{0:d}") %>' />
                                                            </td>
                                                            <td class="PreRow">
                                                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("Nights") %>' />
                                                            </td>
                                                            <td class="PreRow">
                                                                <asp:Label ID="Label7" runat="server" Text='<%# Eval("RoomTypeID") %>' />
                                                            </td>
                                                            <td class="PreRow">
                                                    ...
                                                    <asp:Panel ID="pnlFootData" runat="server" Visible='<%# rptProforma.Items.Count > 0 %>'>
                                                        <tr>
                                                            ...
                                                            <td class="PreRowHead" style="text-align: right; font-style: normal;">
                                                                <asp:Label ID="Label3c" runat="server" Text='<%# hdProformaAmount.Value %>' />
                                                            </td>
                                                        </tr>
                                                    </asp:Panel>
        ...
        <Triggers>
            ...
            <%--<asp:PostBackTrigger ControlID="btnWarningYes" />--%>
            <%--<asp:PostBackTrigger ControlID="btnWarningNC" />--%>
        </Triggers>
    </asp:UpdatePanel>
