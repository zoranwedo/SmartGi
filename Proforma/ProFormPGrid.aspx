<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProFormPGrid.aspx.vb" Inherits="Proforma_ProFormPGrid" %>
                ...
                <tr>
                    <td class="GridBorder" style="vertical-align: top; border-bottom: none;">
                        <asp:Panel ID="pnlRates" runat="server" style="table-layout: fixed; width: 1285px; max-width: 1300px; max-height: 300px;" ScrollBars="Vertical">
                            <asp:GridView ID="gvSuppRates" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Supplement">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkSuppl" runat="server" CommandName="Select" Text='<%# Eval("SupTitle") %>' style="padding: 0px 3px 0px 3px;" Width="250px" ToolTip="Select for details" />
                                        </ItemTemplate>
