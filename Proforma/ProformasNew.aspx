<%@ Page Title="" Language="VB" MasterPageFile="~/masterSMART.master" AutoEventWireup="false" 
    CodeFile="ProformasNew.aspx.vb" Inherits="Proforma_ProformasNew" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterContent" Runat="Server">
                ...
                <td class="GridBorder" style="width: 600px">
                    <asp:Panel ID="pnSearch" runat="server">
                        ...
                        <asp:Panel ID="pnSearchPart" runat="server" style="padding-left: 8px;" DefaultButton="btnSearch">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="GridRow1B" style="width: 120px;" >Group Code/Name</td>
                                ...
                                <tr>
                                    <td class="ComandRow2T" colspan="2" style="height: 30px; padding-top: 5px">
                                        <span style="float: left;">
                                            <asp:Button ID="btnNew" runat="server" Text="New Proforma" SkinID="skBtnBase" CssClass="ButtonRed" style="margin-right: 5px;" />
                                            <asp:Button ID="btmMulti" runat="server" Text="New Multiple Proformas" SkinID="skBtnBase" CssClass="ButtonRed" />
                                        </span>
                    ...
                    <td class="GridBorder">
                        ...
                        <asp:GridView ID="gvSearch" runat="server" AutoGenerateColumns="False" DataKeyNames="InvDocID" DataSourceID="dsFilteredProforma" SkinID="skGridView">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="(ID)" SortExpression="InvDocID">
                                    <ItemTemplate>
                                        (<asp:HyperLink ID="HyperLink1" runat="server" 
                                            NavigateUrl='<%# "~/Proforma/ProForm.aspx?ProformaID=" & Eval("InvDocID") %>' 
                                            Text='<%# Eval("InvDocID") %>' />)
                                    </ItemTemplate>
                                ...
                                <asp:BoundField DataField="TourOpID" HeaderText="TourOpID" SortExpression="TourOpID" Visible="False" >
                                </asp:BoundField>
    ...
    <asp:ObjectDataSource ID="dsFilteredProforma" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        TypeName="dsProformaTableAdapters.ProformaSearchTableAdapter">
        <SelectParameters>
