...
Partial Class Proforma_ProCreateSingleNew
    ...
    Protected Sub btnCheck_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCheck.Click
        ...
        Try
            ...
            Dim dtMulti As List(Of Preinvoicing.ProformaCreateModel) = _proforma.CheckMultiProformas()
    ...
    Protected Sub dlMulti_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles dlMulti.ItemDataBound
        ...
        Dim pro As Preinvoicing.ProformaCreateModel = CType(e.Item.DataItem, Preinvoicing.ProformaCreateModel)
        ...
        dlRes.DataSource = pro.Reservations
        dlRes.DataBind()
