<%@ Page Title="" Language="VB" CodeFile="InvoiceForm.aspx.vb" Inherits="Invoices_InvoiceForm" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterContent" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ShowStayModalRO(BillingID) {
            var frame = $get('IframeStay');
            frame.src = "InvoiceFormSGrid.aspx?BillingID=" + BillingID + "&Edit=0";
            $find("StayModalPopup")._backgroundElement.onclick = function() { document.getElementById("dumyStayCancel").click(); }
            $find('StayModalPopup').show();
        }
                        ...
                        <td>
                            <asp:FormView ID="fvInvoiceHead" runat="server" Width="100%"
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hfAccPeriod" runat="server" Value='<%# Eval("AccPeriod") %>' />
                                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                        <tr>
                                            ...
                                            <td class="GridRow2T" style="margin-top: 2px; padding-top: 5px; text-align: left;">
                                                <div class="Red">
                                                    <asp:Button ID="btnCancel" runat="server" CommandName="CancelInv" SkinID="skBtnBase"
                                                        ...
                                                        OnClientClick="return confirm('Are you sure you want to change invoice state?')" 
                                ...
                                <td class="GridBorder" style="vertical-align: top;">
                                    <asp:DataList  ID="dlStay" runat="server" DataSourceID="dsInvStay" 
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="InvRow" style="width: 100px; font-weight: normal;">
                                                    <asp:Label ID="Label20" runat="server" Text='<%# Eval("BookingVoucher") %>' ToolTip='<%# Eval("BookingVoucher") %>' 
                                                        style="display: block; max-width: 98px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" />
                                                </td>
                                            ...
                                            <asp:DataList ID="dlBill" runat="server" DataSourceID="dsInvBill"
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="InvRowBill" style="width: 130px; font-weight: bold">                             <%--120px--%>
                                                        ...
                                                        <td class="InvRowBillNum" style="width: 21px;">
                                            ...
                                            <asp:DataList ID="dlConcept" runat="server" DataSourceID="dsStayConcept"
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="InvRowBillSel" style="width: 690px; font-weight: bold; text-align: right; border-left-style: none; border-top: solid 1px;">
                                            ...
                                            <asp:DataList ID="dlBill" runat="server" DataSourceID="dsInvBill">
                                                <HeaderTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="InvHeadBill" style="width: 130px;">Rate</td>     <%--120px--%>
                                                        <td class="InvHeadBill" style="width: 21px;">P1</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P2</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P3</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P4</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P5</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P6</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P7</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P8</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P9</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P10</td>
                                                        <td class="InvHeadBill" style="width: 21px;">Ex</td>
                                                        <td class="InvHeadBill" style="width: 21px;">C1</td>
                                                        <td class="InvHeadBill" style="width: 21px;">C2</td>
                                                        <td class="InvHeadBill" style="width: 21px;">C3</td>
                                                        <td class="InvHeadBill" style="width: 21px;">C4</td>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="InvRowBillSel" style="width: 130px; font-weight: bold;">             <%--120px--%>
                                                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("RateCodeId") %>' />
                                                        </td>
                                                        <td class="InvRowBillNumSel" style="width: 21px;">
                                        ...
                                        <SelectedItemTemplate>
                                            ...
                                            <asp:DataList ID="dlBill" runat="server" DataSourceID="dsInvBill"
                                                ...
                                                <HeaderTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="InvHeadBill" style="width: 35px;">Nts#</td>
                                                        <td class="InvHeadBill" style="width: 130px;">Rate</td>                             <%--120px--%>
                                                        <td class="InvHeadBill" style="width: 21px;">P1</td>                                <%-- 24px--%>
                                                        <td class="InvHeadBill" style="width: 21px;">P2</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P3</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P4</td>
                                                        <td class="InvHeadBill" style="width: 21px;">P5</td>
                                            ...
                                            <asp:DataList ID="dlBillEdit" runat="server" DataSourceID="dsInvBill" 
                                                Visible="false"
                                                OnCancelCommand="dlBillEdit_CancelCommand"
                                                OnUpdateCommand="dlBillEdit_UpdateCommand">
                                                <HeaderTemplate>
                                                    <table cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                                    <tr>
                                                        <td style="width: 230px;">&nbsp;</td>                                               <%--253px--%>
                                                ...
                                                <EditItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="InvRowBillSel" style="width: 130px; font-weight: bold;" >                <%--120px--%>
                                                            <asp:TextBox ID="txtStayRate" runat="server" Text='<%# Bind("RateCodeId") %>' CssClass="TextBox" />
