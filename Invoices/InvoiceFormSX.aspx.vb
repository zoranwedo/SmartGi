...
Partial Class Invoices_InvoiceFormSX
    ...
    Protected CanCharge As Boolean = False
    Protected InvSource As String = "SX"
    ...
    Protected Function InvSourceStr() As String
        Return InvSource
    End Function
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If s = "SH" Then
                Response.Write("<h3>This is not an SX invoice</h3>")
                Response.Write(String.Format("<h3><a href='InvoiceForm.aspx?InvoiceID={0}'>Go to invoice</a> or go back.</h3>", Request.QueryString("InvoiceID")))
                Response.End()
            End If
            InvSource = s
        End If
    ...
    Protected Sub cbRVCci_CheckedChanged(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs)
        ...
        Try
            ...
            'Response.Redirect("InvoiceFormSX.aspx?InvoiceID=" & Request.QueryString("InvoiceID"), True)
        Catch ex As Exception
            logTXT = logTXT & " ERROR: " & ex.Message
            l.LogUserAction(logUSR, LogApp.objInv, LogApp.evnState, LogApp.stateError, logINV, logTXT)
            popShow("Updating state", ex)
    ...
    Protected Sub dlBill_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
    ...
    Protected Sub dlBill_CancelCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        Dim dlBill As DataList = source
        dlBill.EditItemIndex = -1
        dlBill.DataBind()
    End Sub

    Protected Sub dlBill_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataListCommandEventArgs)
        Dim dlBill As DataList = source
        ...
        Try
            ...
            Dim q As New dsInvoiceSXTableAdapters.QueriesTableAdapter
            q.InvBillUpdateSX(billingID, amount, user)
